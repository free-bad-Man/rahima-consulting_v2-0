            ...
            {isYandexLoading ? (
              ...
              <>
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
                  ...
                  <path d="M13.5 7.5H11.4C9.8 7.5 8.9 8.3 8.9 9.8C8.9 11.6 9.9 12.3 11.3 13.2L12.8 14.1L8.7 20.5H6L9.8 14.5C7.9 13.3 6.5 12.2 6.5 9.9C6.5 7.2 8.4 5.5 11.4 5.5H16V20.5H13.5V7.5Z" fill="white"/>
                </svg>
                Войти через Яндекс
              </>
            )}
