...
export function TestimonialCarousel({
  ...
  return (
    <section
      ...
      className={cn(
        'relative w-full overflow-hidden rounded-2xl p-6 shadow-sm backdrop-blur',
        className
      )}
    >
      {/* arrows */}
      {showArrows && count > 1 && (
        <>
          <button
            ...
            className='absolute left-3 top-1/2 -translate-y-1/2 rounded-full p-2 text-white/60 ring-1 ring-white/20 transition hover:bg-white/10 hover:text-white'
          >
          ...
          <button
            ...
            className='absolute right-3 top-1/2 -translate-y-1/2 rounded-full p-2 text-white/60 ring-1 ring-white/20 transition hover:bg-white/10 hover:text-white'
          >
  ...
  return (
    ...
    >
        ...
        <div className='relative mb-3'>
          {item.avatar ? (
            <img
              ...
              className={cn(
                'h-16 w-16 rounded-full object-cover ring-2 ring-white/20',
                avatarClassName
              )}
              style={ring}
              loading='lazy'
            ...
            <div
              className={cn(
                'grid h-16 w-16 place-items-center rounded-full bg-white/10 text-white',
                avatarClassName
              )}
              style={ring}
            >
      ...
      {item.quote && (
        <p
          className={cn(
            'text-balance max-w-2xl text-sm leading-7',
            quoteClassName
          )}
        >
          {item.quote}
